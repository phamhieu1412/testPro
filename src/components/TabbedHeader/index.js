...
import StickyParallaxHeader from '../../TypeScript/index.d';
import {
  scrollPosition,
  responsiveWidth,
  deviceHeight,
...
import { Color, Sizes } from '../../common';
import styles from './styles';
import RenderContent from './defaultProps';
...
export default class TabbedHeader extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      _valueAnim: new Animated.ValueXY({
        x: 0,
        y: 0,
      }),
    };
  ...
  scrollPosition = (value) => {
    ...
    return scrollPosition(headerLayout.height, value);
  };
    ...
    const renderImage = () => {
      const logo =
        foregroundImage === undefined
          ? require('../../images/icons/photosPortraitMe.png')
          : foregroundImage;
